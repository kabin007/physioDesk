    ...
    <>
        ...
        >
          <fieldset className="grid gap-4 sm:grid-cols-2">
            ...
            <FormField id="full_name" label="Full name" error={errors.full_name?.message} className="sm:col-span-2">
              <Input {...fieldAria("full_name", errors.full_name?.message)} {...form.register("full_name")} />
            </FormField>
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <Select value={field.value ?? ""} onValueChange={field.onChange}>
                      <SelectTrigger {...fieldAria("gender", errors.gender?.message)} className="w-full">
            ...
            <FormField id="address" label="Address" optional error={errors.address?.message} className="sm:col-span-2">
              <Input {...fieldAria("address", errors.address?.message)} {...form.register("address")} />
            </FormField>
          </fieldset>
          ...
          <fieldset className="grid gap-4 sm:grid-cols-2">
            ...
            <FormField id="condition" label="Condition" error={errors.condition?.message} className="sm:col-span-2">
              <Input
            ...
            <FormField id="assigned_therapist_id" label="Assigned therapist" error={errors.assigned_therapist_id?.message}>
              <Controller
                control={form.control}
            ...
            <FormField id="package" label="Package" optional error={errors.package?.message} className="sm:col-span-2">
              <Input
